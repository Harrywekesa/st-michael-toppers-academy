...
// Get recent notices
$notices = $pdo->query("SELECT * FROM notices ORDER BY date_posted DESC LIMIT 5")->fetchAll();
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="btn-group w-100" role="group">
                                                        ...
                                                        <a href="teacher_attendance.php?class_id=<?php echo $class['id']; ?>&date=<?php echo $today; ?>" class="btn btn-outline-success btn-sm">
                            ...
                            <?php else: ?>
                                <?php foreach($notices as $notice): ?>
                                    <div class="border-bottom pb-2 mb-2">
                                        ...
                                        <p class="mb-1"><?php echo substr(htmlspecialchars($notice['content']), 0, 100) . '...'; ?></p>
                                        <small class="text-muted"><?php echo date('M j, Y', strtotime($notice['date_posted'])); ?></small>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="teacher_attendance.php" class="btn btn-success">
                                    <i class="fas fa-calendar-check"></i> Mark Attendance
                                </a>
                                <a href="teacher_reports.php" class="btn btn-warning">
